 ...
 *
 * It caches created {@link WasbUnderFileSystem}s, using the scheme and authority pair as the key.
 */
@ThreadSafe
public final class WasbUnderFileSystemFactory implements UnderFileSystemFactory {
  /**
  ...
  public UnderFileSystem create(String path, Object conf) {
    ...
    return new WasbUnderFileSystem(new AlluxioURI(path), conf);
  }
